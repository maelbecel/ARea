...
You will find here the documentation of the server application.
...
Field for authentication method is **authMethod**. It's an enum, only value possible is oauth2 for the moment.
